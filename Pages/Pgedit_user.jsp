...
if (session.getAttribute("login") != null && session.getAttribute("function") != null ){
    ...
    if(val != null){
        ...
        sqlSelectRecord = "SELECT * FROM user WHERE Login='" + val + "'";
        ...
        if(rsSelectRecord.next()){
            ...
            //out.println(tel);
            String type = rsSelectRecord.getString("Type");
            //out.println(type);
...
<body>
    <div id="frm2">
        <form name="f1" action="loading.jsp" method="POST">
            <center>
                ...
                <input type="number" id="type" name="type" required placeholder="Type" value="<%= type %>" min="1" max="4"/><br><br>
...
<%
        ...
        response.sendRedirect("userManagement.jsp?state=5");
    }
}else {
