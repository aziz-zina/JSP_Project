...
if (session.getAttribute("login") != null && session.getAttribute("function") != null ){
    if(!session.getAttribute("function").equals("2") && !session.getAttribute("function").equals("1")){
        ...
        <table class="table table-hover">
            ...
            if (session.getAttribute("login") != null && session.getAttribute("function") != null ){
                if(session.getAttribute("function").equals("2") || session.getAttribute("function").equals("1")){
                    ...
                    sqlSelectRecord = "SELECT * FROM reservation AS r INNER JOIN user as U1 ON r.idClient = U1.Login INNER JOIN user as U2 ON r.EmployeeUser = U2.Login WHERE EmployeeUser='" + session.getAttribute("login") + "' ORDER BY idReservation";
