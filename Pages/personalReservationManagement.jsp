        ...
        <table class="table table-hover">
            ...
            if (session.getAttribute("login") != null && session.getAttribute("function") != null ){
                if(!session.getAttribute("function").equals("4")){
                    ...
                    sqlSelectRecord = "SELECT * FROM reservation AS r INNER JOIN user as U1 ON r.idClient = U1.Login INNER JOIN user as U2 ON 	r.EmployeeUser = U2.Login where idClient='" + session.getAttribute("login") + "' ORDER BY time ";
